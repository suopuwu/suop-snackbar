class Snackbar {
  ...
  constructor({
    ...
    this.node.addEventListener('click', (e) => {
      if (e.target.classList.contains('mSnackbar-close-button'))
        this.close()
    })
  ...
  close() {
    console.log(suopSnackbar.snackbars);
...
class SuopSnackbarAction {
  ...
  color;
  onClick;
  constructor(text = 'action', onClick = function () {
...
var suopSnackbar = {
  ...
  add: function ({
    ...
    container.style.transform = 'transform', `translateY(${-container.clientHeight}px)`;
